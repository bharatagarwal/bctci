...
# return the values of its children as an array of at-most 2
...
# return the values of its grandchildren as an array of length at most 4.
...
# Return the size of the node's subtree. A node's subtree includes itself and all of its descendants.
def subtree_height():
    pass
